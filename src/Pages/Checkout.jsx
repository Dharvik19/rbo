...
const Checkout = () => {
    ...
    const onproceed = async (e) => {
        ...
        if (validateForm()) {
            ...
            const response = await axios.post(`${BASE_URL}/app/apis/placeorder`, data);
            ...
            var flow_config = {
                ...
                "authToken": order.authorization,
                "childWindow": false,
                // "returnUrl": "https://redbluorange.in/school/pg/pgresponse.php",
                "retryCount": 3,
                "prefs": { "payment_categories": ["card", "nb", "upi", "qr", "gpay"] }
            }

            /* "prefs": {"payment_categories": ["card", "emi", "nb", "upi", "wallets", "qr", "gpay"]  */

            var responseHandler = async function (txn) {
                console.log("callback received status", txn)
                ...
                if (txn.status === 200) {
                    ...
                    await axios.post(`${BASE_URL}/app/apis/orderrecheck`, validate)
                        .then((res) => {
            ...
            try {
                const bill = new window.loadBillDeskSdk(config);
                bill.open();
                e.preventDefault();
            } catch (e) {
                console.log(e)
        ...
        <div className='p-3'>
            ...
            <h4>
                ...
                Remove
                            ...
                            <div>
                                <button type='button' onClick={()=>onproceed()} class="btn btn-primary btn-shadow d-block w-100 mt-4">
